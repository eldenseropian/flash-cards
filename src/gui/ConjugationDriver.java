...
public class ConjugationDriver extends JFrame implements ActionListener {
	...
	/** Which verb the user is currently on. 0 <= currentIndex < instructions.size() */
	 ...
	 * @param instructions instruction detailing the verb to be conjugated and the desired tense
	...
	public static void main(String[] args) {
		...
		String[] hablar = {"hablo", "hablamos", "hablas", "habl‡is", "habla", "hablan"};
	...
	/**
	 * Change to the next verb when the user presses the "Next" button. Wraps around.
	 */
	@Override
